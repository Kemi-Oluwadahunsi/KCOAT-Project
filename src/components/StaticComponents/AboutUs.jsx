...
const AboutUs = () => {
  ...
  return (
    <div className="border-l-8 border-simple1 pt-[8rem] xs:px-[2rem] md:px-[10em] px-[20em] pb-[4em] text-justify flex flex-col gap-[2rem] font-oxygen text-categoryborder">
      <div className="flex flex-col gap-[2em]">
        <div className="flex flex-col gap-4">
          <h2 className="font-bold text-[2rem]  xs:text-[1.1rem] md:text-[1.5rem]">
        ...
        <div className="flex flex-col gap-4">
          <h2 className="font-bold text-[1.5em] xs:text-[1.2em]">
        ...
        <p className="text-[1.2em] xs:text-base">
          ...
          <Link
            to="/all-products"
            className="text-tertiary font-tertiary cursor-pointer"
            onClick={scrollToTop}
          >
            KCOAT{" "}
          </Link>{" "}
          today and embark on a journey of effortless style and confident
          expression.
        </p>
      </div>
    </div>
